...
class TestNoFlyCheck:
    ...
    def test_check_available(self, mock_get, client):
        """WMS available returns status."""
        mock_resp = MagicMock()
        mock_resp.status_code = 200
        mock_get.return_value = mock_resp

        res = client.get("/api/nofly/check")
    ...
    @patch("app.http_requests.get")
    def test_check_unavailable(self, mock_get, client):
    ...
    @patch("app.http_requests.get")
    def test_check_timeout(self, mock_get, client):
    ...
    @patch("app.http_requests.get")
    def test_check_connection_error(self, mock_get, client):
    ...
    @patch("app.http_requests.get")
    def test_check_calls_correct_url(self, mock_get, client):
        """Verify correct WMS URL and params are used."""
        mock_resp = MagicMock()
        mock_resp.status_code = 200
        mock_get.return_value = mock_resp

        client.get("/api/nofly/check")
...
class TestNoFlyFeatureInfo:
    ...
    def test_missing_params(self, client):
        ...
        res = client.get("/api/nofly/info")
        assert res.status_code == 400
        data = res.get_json()
        assert "error" in data

    def test_missing_lat(self, client):
        res = client.get("/api/nofly/info?lon=8.0&layers=dipul:flughaefen")
        assert res.status_code == 400

    def test_missing_lon(self, client):
        res = client.get("/api/nofly/info?lat=52.0&layers=dipul:flughaefen")
        assert res.status_code == 400

    def test_missing_layers(self, client):
        res = client.get("/api/nofly/info?lat=52.0&lon=8.0")
        assert res.status_code == 400

    @patch("app.http_requests.get")
    def test_successful_feature_info(self, mock_get, client):
        ...
        res = client.get("/api/nofly/info?lat=50.03&lon=8.57&layers=dipul:flughaefen")
        assert res.status_code == 200
        data = res.get_json()
    ...
    @patch("app.http_requests.get")
    def test_empty_feature_info(self, mock_get, client):
        ...
        res = client.get("/api/nofly/info?lat=52.0&lon=8.0&layers=dipul:flughaefen")
        assert res.status_code == 200
        data = res.get_json()
        assert data["type"] == "FeatureCollection"
    ...
    @patch("app.http_requests.get")
    def test_wms_error_status(self, mock_get, client):
    ...
    @patch("app.http_requests.get")
    def test_correct_wms_params(self, mock_get, client):
        ...
        client.get("/api/nofly/info?lat=52.0302&lon=8.5325&layers=dipul:kontrollzonen")
        call_args = mock_get.call_args
    ...
    @patch("app.http_requests.get")
    def test_multiple_layers(self, mock_get, client):
        ...
        client.get(f"/api/nofly/info?lat=52.0&lon=8.0&layers={layers}")
        call_args = mock_get.call_args
        assert call_args[1]["params"]["layers"] == layers

    @patch("app.http_requests.get")
    def test_bbox_constructed_correctly(self, mock_get, client):
        ...
        client.get("/api/nofly/info?lat=52.0&lon=8.0&layers=dipul:flughaefen")
        call_args = mock_get.call_args
